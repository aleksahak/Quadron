...
The Quadron methodology, developed via gradient boosting machines trained on the experimental G4-seq data, is described and validated in detail at <http://dx.doi.org/ToBePublished>.
